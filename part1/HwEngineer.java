...
public class HwEngineer extends Employee implements SalaryRaisable {
    /**
     * Constructor for HWEngineer
     * 
     * @param name       name of HW Engineer
     * @param baseSalary base salary of HW Engineer
     */
    ...
    /**
     * @return {@code double} raised salary after increasing the base salary by the
     *         given rate
     */
