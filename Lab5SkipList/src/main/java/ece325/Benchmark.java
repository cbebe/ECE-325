...
public class Benchmark {
    /**
     * Modifies the given list, changing each element to the result of computing
     * base power the element
     * 
    ...
    /**
     * Computes the position in the given {@code list} where the given {@code elem}
     * is greater than the current elements in the list.
     * 
     * @param list {@code List<T>} of values
     * @param elem {@code T} element to look for
     * @return The position in the list where elem is grater than the element in the
     *         list.
     */
    ...
    /**
     * Execute the bechmark using the given empty {@code list} of elements, and
     * executing the benchmark with the given number of elements specified by
     * {@code numElements}, and repeating each test {@code iteration} times
     * 
     * @param list       {@code List<Integer>} empty list to use
     * @param numElemens {@code List<Integer>} list specifying the number of
     *                   elements to use on each test
    ...
    private static void benchmark(List<Integer> list, List<Integer> numElemens, int iterations) {
        ...
        for (int n : numElemens) {
            ...
            System.out.println(
                    list.getClass().getName() + ",\t" + n + ",\t" + timer1.average() + ",\t" + timer2.average());
        }
    }
